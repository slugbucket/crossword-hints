...
INSERT INTO cue_words(cue_word, created_at, updated_at) values
("primarily", datetime('now'), datetime('now')),
("initially", datetime('now'), datetime('now')),
("partially", datetime('now'), datetime('now')),
("oddly", datetime('now'), datetime('now')),
("evenly", datetime('now'), datetime('now')),
("almost", datetime('now'), datetime('now')),
("mostly", datetime('now'), datetime('now')),
("somewhat", datetime('now'), datetime('now')),
("part of", datetime('now'), datetime('now')),
("sorted", datetime('now'), datetime('now')),
("mixed", datetime('now'), datetime('now')),
("confused", datetime('now'), datetime('now')),
("confusing", datetime('now'), datetime('now')),
("strange", datetime('now'), datetime('now')),
("strangely", datetime('now'), datetime('now')),
("muddled", datetime('now'), datetime('now')),
("broken", datetime('now'), datetime('now')),
("fixed", datetime('now'), datetime('now')),
("shattered", datetime('now'), datetime('now')),
("extereme", datetime('now'), datetime('now')),
("extremely", datetime('now'), datetime('now')),
("outside", datetime('now'), datetime('now')),
("left", datetime('now'), datetime('now')),
("right", datetime('now'), datetime('now')),
("port", datetime('now'), datetime('now')),
("shocking", datetime('now'), datetime('now')),
("blown up", datetime('now'), datetime('now')),
("centre", datetime('now'), datetime('now')),
("central", datetime('now'), datetime('now')),
("supported", datetime('now'), datetime('now')),
("shortly", datetime('now'), datetime('now')),
("leader", datetime('now'), datetime('now')),
("awkward", datetime('now'), datetime('now')),
("loud", datetime('now'), datetime('now')),
("quiet", datetime('now'), datetime('now')),
("quietly", datetime('now'), datetime('now'));
